...
public class CreateCalisanDTO {
	...
	public CreateCalisanDTO() {
		super();
	}
	public CreateCalisanDTO(String ad, String soyAd, String eposta, long telefon, Date iseGirisTarihi, long maas,
